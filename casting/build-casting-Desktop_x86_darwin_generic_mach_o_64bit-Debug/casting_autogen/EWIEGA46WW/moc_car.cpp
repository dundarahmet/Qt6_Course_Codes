...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Car_t, stringdata0) + ofs), len 
...
const QMetaObject Car::staticMetaObject = { {
    ...
    qt_meta_stringdata_Car.offsetsAndSize,
    qt_meta_data_Car,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Car_t
